...
parallel firstBranch: {
	node ('atlas_WinOS_New') {
		...
		dir (env.WORKSPACE){
			...
			stage ('MyAIS_AISeStatement_Production_Sequential')
			{
...
def run_MyAIS_Quickmenu_VerifyButton_Production(runner){
	if(runner.Quickmenu_VerifyButton || runner.All){
		dir(env.WORKSPACE) {
			...
			bat 'rebot --outputdir '+ env.outputPath +'\\Quickmenu_VerifyButton -o output_3BO_EN.xml -l log3BO_EN.html -r report3BO_EN.html  -R -N 3BO --nostatusrc '+ env.outputPath +'\\Quickmenu_VerifyButton\\output*_EN_3BO.xml'
			bat 'rebot --outputdir '+ env.outputPath +'\\Quickmenu_VerifyButton -o output_3PO_EN.xml -l log3PO_EN.html -r report3PO_EN.html  -R -N 3PO --nostatusrc '+ env.outputPath +'\\Quickmenu_VerifyButton\\output*_EN_3PO.xml'
			bat 'rebot --outputdir '+ env.outputPath +'\\Quickmenu_VerifyButton -o outputEN.xml -N EN -l log.html -r report.html --nostatusrc --starttime "' + START_TIME_EN + '" --endtime "' + END_TIME_EN + '" '+ env.outputPath +'\\Quickmenu_VerifyButton\\output_3BE_EN.xml '+ env.outputPath +'\\Quickmenu_VerifyButton\\output_3PE_EN.xml '+ env.outputPath +'\\Quickmenu_VerifyButton\\output_3BO_EN.xml '+ env.outputPath +'\\Quickmenu_VerifyButton\\output_3PO_EN.xml '
			def START_TIME_TH = getTime()
			echo START_TIME_TH
			...
			bat 'rebot --outputdir '+ env.outputPath +'\\Quickmenu_VerifyButton -o output_3PO_TH.xml -l log3PO_TH.html -r report3PO_TH.html  -R -N 3PO --nostatusrc '+ env.outputPath +'\\Quickmenu_VerifyButton\\output*_TH_3PO.xml'
			bat 'rebot --outputdir '+ env.outputPath +'\\Quickmenu_VerifyButton -o output_3BO_TH.xml -l log3BO_TH.html -r report3BO_TH.html  -R -N 3BO --nostatusrc '+ env.outputPath +'\\Quickmenu_VerifyButton\\output*_TH_3BO.xml'
			bat 'rebot --outputdir '+ env.outputPath +'\\Quickmenu_VerifyButton -o outputTH.xml -N TH -l log.html -r report.html --nostatusrc --starttime "' + START_TIME_TH + '" --endtime "' + END_TIME_TH + '" '+ env.outputPath +'\\Quickmenu_VerifyButton\\output_3BE_TH.xml '+ env.outputPath +'\\Quickmenu_VerifyButton\\output_3PE_TH.xml '+ env.outputPath +'\\Quickmenu_VerifyButton\\output_3PO_TH.xml '+ env.outputPath +'\\Quickmenu_VerifyButton\\output_3BO_TH.xml '
...
def run_MyAIS_Quickmenu_VerifyMenu_Production(runner){
	if(runner.Quickmenu_VerifyMenu || runner.All){
		dir(env.WORKSPACE) {
			...
			bat 'rebot --outputdir '+ env.outputPath +'\\Quickmenu_VerifyMenu -o output_3BO_EN.xml -l log3BO_EN.html -r report3BO_EN.html  -R -N 3BO --nostatusrc '+ env.outputPath +'\\Quickmenu_VerifyMenu\\output*_EN_3BO.xml'
			bat 'rebot --outputdir '+ env.outputPath +'\\Quickmenu_VerifyMenu -o output_3PO_EN.xml -l log3PO_EN.html -r report3PO_EN.html  -R -N 3PO --nostatusrc '+ env.outputPath +'\\Quickmenu_VerifyMenu\\output*_EN_3PO.xml'
			bat 'rebot --outputdir '+ env.outputPath +'\\Quickmenu_VerifyMenu -o outputEN.xml -N EN -l log.html -r report.html --nostatusrc --starttime "' + START_TIME_EN + '" --endtime "' + END_TIME_EN + '" '+ env.outputPath +'\\Quickmenu_VerifyMenu\\output_3BE_EN.xml '+ env.outputPath +'\\Quickmenu_VerifyMenu\\output_3PE_EN.xml '+ env.outputPath +'\\Quickmenu_VerifyMenu\\output_3BO_EN.xml '+ env.outputPath +'\\Quickmenu_VerifyMenu\\output_3PO_EN.xml '
			def START_TIME_TH = getTime()
			echo START_TIME_TH
			...
			bat 'rebot --outputdir '+ env.outputPath +'\\Quickmenu_VerifyMenu -o output_3PO_TH.xml -l log3PO_TH.html -r report3PO_TH.html  -R -N 3PO --nostatusrc '+ env.outputPath +'\\Quickmenu_VerifyMenu\\output*_TH_3PO.xml'
			bat 'rebot --outputdir '+ env.outputPath +'\\Quickmenu_VerifyMenu -o output_3BO_TH.xml -l log3BO_TH.html -r report3BO_TH.html  -R -N 3BO --nostatusrc '+ env.outputPath +'\\Quickmenu_VerifyMenu\\output*_TH_3BO.xml'
			bat 'rebot --outputdir '+ env.outputPath +'\\Quickmenu_VerifyMenu -o outputTH.xml -N TH -l log.html -r report.html --nostatusrc --starttime "' + START_TIME_TH + '" --endtime "' + END_TIME_TH + '" '+ env.outputPath +'\\Quickmenu_VerifyMenu\\output_3BE_TH.xml '+ env.outputPath +'\\Quickmenu_VerifyMenu\\output_3PE_TH.xml '+ env.outputPath +'\\Quickmenu_VerifyMenu\\output_3PO_TH.xml '+ env.outputPath +'\\Quickmenu_VerifyMenu\\output_3BO_TH.xml '
...
def run_Quickmenu_Search_Postpaid(runner){
	if(runner.Quickmenu_Search_Postpaid || runner.All){
		dir(env.WORKSPACE) {
			...
			def END_TIME_EN = getTime()
			echo END_TIME_EN
			bat 'rebot --outputdir '+ env.outputPath +'\\Quickmenu_Search_Postpaid -o output_3BO_EN.xml -l log3BO_EN.html -r report3BO_EN.html  -R -N 3BO --nostatusrc '+ env.outputPath +'\\Quickmenu_Search_Postpaid\\output*_EN_3BO.xml'
			bat 'rebot --outputdir '+ env.outputPath +'\\Quickmenu_Search_Postpaid -o output_3PO_EN.xml -l log3PO_EN.html -r report3PO_EN.html  -R -N 3PO --nostatusrc '+ env.outputPath +'\\Quickmenu_Search_Postpaid\\output*_EN_3PO.xml'
			bat 'rebot --outputdir '+ env.outputPath +'\\Quickmenu_Search_Postpaid -o outputEN.xml -N EN -l log.html -r report.html --nostatusrc --starttime "' + START_TIME_EN + '" --endtime "' + END_TIME_EN + '" '+ env.outputPath +'\\Quickmenu_Search_Postpaid\\output_3BO_EN.xml '+ env.outputPath +'\\Quickmenu_Search_Postpaid\\output_3PO_EN.xml '
			def START_TIME_TH = getTime()
			echo START_TIME_TH
			...
			def END_TIME_TH = getTime()
			echo END_TIME_TH
			bat 'rebot --outputdir '+ env.outputPath +'\\Quickmenu_Search_Postpaid -o output_3PO_TH.xml -l log3PO_TH.html -r report3PO_TH.html  -R -N 3PO --nostatusrc '+ env.outputPath +'\\Quickmenu_Search_Postpaid\\output*_TH_3PO.xml'
			bat 'rebot --outputdir '+ env.outputPath +'\\Quickmenu_Search_Postpaid -o output_3BO_TH.xml -l log3BO_TH.html -r report3BO_TH.html  -R -N 3BO --nostatusrc '+ env.outputPath +'\\Quickmenu_Search_Postpaid\\output*_TH_3BO.xml'
			bat 'rebot --outputdir '+ env.outputPath +'\\Quickmenu_Search_Postpaid -o outputTH.xml -N TH -l log.html -r report.html --nostatusrc --starttime "' + START_TIME_TH + '" --endtime "' + END_TIME_TH + '" '+ env.outputPath +'\\Quickmenu_Search_Postpaid\\output_3BO_TH.xml '+ env.outputPath +'\\Quickmenu_Search_Postpaid\\output_3PO_TH.xml '
